...
const Footer = () => {
    return (
        <div className='bg-[#101727]'>
            <div className='max-w-7xl mx-auto pt-28 pb-8 px-2'>
                <div className='grid md:grid-cols-3 lg:grid-cols-12 gap-12 mb-20'>
                ...
                <div className='flex justify-between items-center px-3 flex-col gap-4 md:flex-row'>
                    <div>
